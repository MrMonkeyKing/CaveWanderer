...
namespace _Scripts.Helper
{
    public class PerlinNoise
    {
        ...
        */
            Vector3 direction000 = _directions[_permutation[permutationY00 + flooredPointZ0] & DirectionCount];
            Vector3 direction100 = _directions[_permutation[permutationY10 + flooredPointZ0] & DirectionCount];
            Vector3 direction010 = _directions[_permutation[permutationY01 + flooredPointZ0] & DirectionCount];
            Vector3 direction110 = _directions[_permutation[permutationY11 + flooredPointZ0] & DirectionCount];
            Vector3 direction001 = _directions[_permutation[permutationY00 + flooredPointZ1] & DirectionCount];
            Vector3 direction101 = _directions[_permutation[permutationY10 + flooredPointZ1] & DirectionCount];
            Vector3 direction011 = _directions[_permutation[permutationY01 + flooredPointZ1] & DirectionCount];
            Vector3 direction111 = _directions[_permutation[permutationY11 + flooredPointZ1] & DirectionCount];
